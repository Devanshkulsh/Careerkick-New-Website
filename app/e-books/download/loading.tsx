export default function EbookDownloadLoading() {
  return (
    <section className="section-shell min-h-screen pt-28 md:pt-36">
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col gap-10 px-4 md:px-8">
        ...
        <div className="mx-auto h-96 w-full max-w-5xl animate-pulse rounded-lg border border-white/10 bg-gradient-card" />
      </div>
    </section>
  );
}
